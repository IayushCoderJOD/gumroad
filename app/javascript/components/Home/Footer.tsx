  ...
  <div className="flex flex-col justify-between gap-16 bg-black px-8 py-16 text-white lg:flex-row lg:px-[4vw] lg:py-24">
    ...
    <div className="flex w-full max-w-3xl flex-col gap-16">
      ...
      <div className="flex justify-between">
        ...
        <a href="https://github.com/antiwork/gumroad" className="hover:text-pink">
          <svg width="33" height="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path 
    d="M12 0.297C5.373 0.297 0 5.67 0 12.297C0 17.422 3.438 21.799 8.207 23.385C8.805 23.481 9.025 23.13 9.025 22.822C9.025 22.54 9.014 21.708 9.008 20.708C5.672 21.383 4.967 19.214 4.967 19.214C4.438 17.863 3.672 17.499 3.672 17.499C2.547 16.777 3.758 16.793 3.758 16.793C4.992 16.883 5.637 18.063 5.637 18.063C6.75 19.97 8.594 19.408 9.287 19.091C9.383 18.341 9.672 17.842 9.996 17.54C7.272 17.237 4.437 16.204 4.437 11.791C4.437 10.479 4.883 9.419 5.641 8.592C5.516 8.286 5.13 7.028 5.758 5.296C5.758 5.296 6.75 4.968 9 6.625C9.945 6.361 10.95 6.229 11.953 6.223C12.957 6.229 13.961 6.361 14.906 6.625C17.156 4.968 18.148 5.296 18.148 5.296C18.777 7.028 18.391 8.286 18.266 8.592C19.027 9.419 19.469 10.479 19.469 11.791C19.469 16.219 16.625 17.232 13.891 17.532C14.281 17.895 14.641 18.603 14.641 19.677C14.641 21.218 14.625 22.438 14.625 22.822C14.625 23.13 14.844 23.486 15.453 23.385C20.219 21.797 23.656 17.42 23.656 12.297C23.656 5.67 18.282 0.297 11.656 0.297H12Z"
    fill="currentColor"
  />
</svg>
